...
const config = {
  ...
  tagline:
    "Secure answers from your own data - AI-powered document intelligence for developers",
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          {
            type: "dropdown",
            label: "VaultiScan Connectors",
            position: "left",
            className: "nav-bold",
            items: [
              {
                type: "docSidebar",
                sidebarId: "googleDriveSidebar",
                label: "Google Drive Connector",
              },
              {
                type: "docSidebar",
                sidebarId: "sharepointSidebar",
                label: "SharePoint Connector",
              },
              {
                type: "docSidebar",
                sidebarId: "dropboxSidebar",
      ...
      metadata: [
        {
          name: "keywords",
          content:
            "embedding sdk, security scanning, vulnerability assessment, api integration, javascript sdk, react components, security automation",
        },
        {
          name: "description",
          content:
            "VaultiScan Embedding SDK allows developers to integrate powerful security scanning capabilities directly into their applications with minimal code.",
        },
        {
          property: "og:title",
          content: "VaultiScan Embedding SDK Documentation",
        },
        {
          property: "og:description",
          content:
            "Embed VaultiScan security scanning into your applications with our comprehensive SDK",
        },
        { property: "og:type", content: "website" },
        {
          property: "og:url",
          content: "https://vaultiscan.github.io/embedding-sdk-docs/",
        },
        {
          property: "og:image",
          content:
            "https://vaultiscan.github.io/embedding-sdk-docs/img/vaultiscan-sdk-social-card.jpg",
        },
        { name: "twitter:card", content: "summary_large_image" },
        { name: "twitter:title", content: "VaultiScan Embedding SDK" },
        {
          name: "twitter:description",
          content: "Integrate security scanning into your applications",
        },
        {
          name: "twitter:image",
          content:
