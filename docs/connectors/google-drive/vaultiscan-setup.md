...
# Configuring the Google Drive Connector in VaultiScan

Configure your Google Drive OAuth credentials in VaultiScan to enable seamless and secure access to Google Drive documents for AI-powered analysis.
...
- You have created your OAuth Client ID and Client Secret in the Google Cloud Console
- You have downloaded and safely stored the credentials JSON file
